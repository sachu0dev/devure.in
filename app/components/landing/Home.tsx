  ...
  return (
    <div className="w-full max-w-[110rem] flex flex-col lg:flex-row h-auto text-background px-3 md:px-6 pb-8 lg:pb-16 pt-[8rem]">
      <div className="w-full lg:w-[50%] flex flex-col justify-between mb-8 lg:mb-0">
        ...
        >
          <p className="mb-6">
            At {env.SITE_NAME}, we help businesses build, launch, and scale
            custom web applications — blending design, development, and
            technical expertise to deliver solutions that work and grow with
            you.
          </p>
