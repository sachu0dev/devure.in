    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-end gap-2">
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-foreground disabled:opacity-50"
            onClick={scrollLeft}
...
export const Card = ({
  ...
  const handleCardClick = () => {
    ...
    if ("slug" in card && card.slug) {
      window.location.href = `/service/${card.slug}`;
    }
  };
